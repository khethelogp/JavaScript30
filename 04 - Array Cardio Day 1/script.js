...
/* 
const category = document.querySelector('.md-category');
...
const alphaB = people.sort((lastOne,nextOne) => {
...
const trasnportation = data.reduce((obj,item) => {
    if(!obj[item]){
        obj[item] = 0;
    }
